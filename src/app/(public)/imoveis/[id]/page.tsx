  ...
  return (
    <div className="bg-paper">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-8 mb-10">
        {photos.length === 0 ? (
          <div className="aspect-[16/9] rounded-3xl bg-cream flex items-center justify-center"><div className="w-24 h-24 bg-terra/20 rounded-2xl flex items-center justify-center"><svg viewBox="0 0 40 40" className="w-12 h-12 text-terra/60" fill="currentColor"><path d="M4 22 L20 6 L36 22 L36 36 L26 36 L26 26 L14 26 L14 36 L4 36 Z" /></svg></div></div>
        ) : (
