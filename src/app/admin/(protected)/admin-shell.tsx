...
import { LayoutDashboard, Building2, Users, FileSignature, Receipt, Target, Globe, ClipboardCheck, BarChart3, Inbox, LogOut, Menu, Star } from 'lucide-react';
import toast from 'react-hot-toast';

const NAV = [
  { section: 'Visão Geral', items: [{ href: '/admin', icon: LayoutDashboard, label: 'Dashboard' }, { href: '/admin/submissoes', icon: Inbox, label: 'Solicitações' }, { href: '/admin/destaque', icon: Star, label: 'Imóvel da Vez' }] },
